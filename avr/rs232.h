...
#endif
#ifndef RS232_RECEIVE_CB
# define  RS232_RECEIVE_CB 1		// set to 0, to avoid callback code
#endif
...
#if (CPU_MHZ_10 == 200)
# define UBRV_1000000	(1/0)	// 2.5 ... sigh
# define UBRV_500000	4	// exact
# define UBRV_250000	9	// exact	(DMX speed)
# define UBRV_230400	10	// untested
# define UBRV_115200	21	// 21 only
# define UBRV_57600	42	// untested
# define UBRV_38400	64	// 62-64-67 tested
# define UBRV_19200	130	// untested
# define UBRV_9600	259	// 247-259-273 tested
# if (U2X_VAL != 1)
#  error "UBRV_* defined only for U2X_VAL == 1"
# endif

#elif (CPU_MHZ_10 == 160)
# define UBRV_1000000	1	// exact
# define UBRV_500000	3	// exact
# define UBRV_250000	7	// exact	(DMX speed)
# define UBRV_230400	8	// untested, -3.5% off
# define UBRV_115200	16	// 16,17 tested
# define UBRV_57600	34	// untested
...
# if (U2X_VAL == 1)
#  define UBRV_1000000	1	// 0.84 untested
#  define UBRV_500000	3	// 2.69 untested
#  define UBRV_250000	6	// 6.37 untested
...
# else
#  define UBRV_1000000	0	// -0.07 untested
#  define UBRV_500000	1	// 0.84 untested
#  define UBRV_250000	3	// 2.69 untested
...
#elif (CPU_MHZ_10 == 80)
# define UBRV_1000000	0	// exact
# define UBRV_500000	1	// exact
# define UBRV_250000	3	// exact	(DMX speed)
# define UBRV_230400	3	// untested, 8.5% off
# define UBRV_115200	8	// 8 only
# define UBRV_57600	16	// untested, 2.1% off
...
#elif (CPU_MHZ_10 == 40)
# define UBRV_1000000	(1/0)	// error_CPU_MHZ_TOO_LOW
# define UBRV_500000	0	// exact
# define UBRV_250000	1	// exact
...
#elif (CPU_MHZ_10 == 25)
# define UBRV_1000000	(1/0)	// error_CPU_MHZ_TOO_LOW
# define UBRV_500000	(1/0)	// error_CPU_MHZ_TOO_LOW
# define UBRV_250000	(1/0)	// unknown
# define UBRV_230400	(1/0)	// unknown
...
# define UBRV_1000000	(1/0)	// error_CPU_MHZ_TOO_LOW
# define UBRV_500000	(1/0)	// error_CPU_MHZ_TOO_LOW
# define UBRV_250000	(1/0)	// error_CPU_MHZ_TOO_LOW
...
#  define UBRV_1000000	(1/0)
#  define UBRV_500000	(1/0)
#  define UBRV_250000	(1/0)
#  define UBRV_230400	(1/0)
...
#define UBRV(x) (((x)==1000000)?UBRV_1000000: \
                (((x)==500000)?UBRV_500000: \
                (((x)==250000)?UBRV_250000: \
                (((x)==230400)?UBRV_230400: \
