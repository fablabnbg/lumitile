...
; 03.05.2006
;	-Baudrate erhöht auf 56kBaud
;	-Datenübernahme bei Addr. 255 und CS Bit5 gesetzt
;
; ********************************************************************************************
	LIST P=16F88
; ********************************************************************************************
...
#define	SPBRG		19	; Baudrate Generation 99H
...
;>>>	OSCCON (8Fh)
	...
	BSF	STATUS, 5
	movlw	b'01111110'	; 8MHz interner Oszillator
	movwf	OSCCON
...
;	movlw	d'016'		; Baudrate: 28,8kBaud
;	movlw	d'012'		; Baudrate: 38,4kBaud
	movlw	d'008'		; Baudrate: 57,6kBaud	
	movwf	SPBRG
	bcf	STATUS, 5
...
RS232_Adr
	...
	btfsc	STATUS, 2
	bsf	RX_Status, 1	; Adresse ist 255
...
RS232_CS_warte
	btfsc	RX_Status, 1	; Sammeladresse kam
	goto	RS232_CS_Sammel
	movf	SOLL_R, W
	movwf	ROT_S
	movf	SOLL_G, W
	movwf	GRUEN_S
