...
; 28.09.2005
;	-Steigung des Stroms von 1:1 umstellen nach I=1/Stellwert
;
; ********************************************************************************************
	LIST P=16F88
; ********************************************************************************************
...
#define	EinDauer	74	; für wieviele Impulse ist EIN
#define	P_Counts	75	; Hilfs Merker für PWM
#define	Hilfs_SW	76
#define	PWM_Ein		77
#define	PORT_B		78
...
TMR0_ISRP
	movf	PWM_Ein, W
	subwf	P_Counts, W
	btfss	STATUS, 0	; immer einschalten, wenn C
