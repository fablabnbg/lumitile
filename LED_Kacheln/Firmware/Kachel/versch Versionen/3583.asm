...
#define	H_CounterT	75	; Holdwert für CounterT
...
#define	StartWert	d'020'	; minimaler Stellwert
#define	IncrWert	d'235'	; = 255 - StartWert

; ********************************************************************************************
; ********************************************************************************************
;16F628-Configs---------------------------------------------------------------------
	__IDLOCS	H'3583' ;       User ID
;-----------------------------------------------------------------------------------
;
_CONFIG1	EQU	H'2007'			    
_CONFIG2	EQU	H'2008'	
...
; RGB_Wert	71	; RGB-Wert vom Controller
; H_Stellwert	72	; Hilfsmerker für Stellwert
; Stell_HW	73	; berechneter Stellwert
; StellWert	74	; Stellwert
; H_CounterT	75	; Holdwert für CounterT
; CounterT	76	; berechneter Counter Wert
; CounterWert	77	; Wert für Counter
; Int_Frei	78	; Freigabe für Übernahme der Werte
; PWM		79	; PWM-Wert (Ringzähler)

; StartTime	d'208'	; kürzester Timer Wert (50us)
; StartWert	d'010'	; minimaler Stellwert
; IncrWert	d'245'	; = 255 - StartWert
