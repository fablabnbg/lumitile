...
; CVRON		(9Dh)
	...
	bsf	STATUS, 5
	movlw	b'01000100'	; Transmit DIS, asynchron, 9-bit, high speed
;	movlw	b'00000000'
	movwf	TXSTA
	bcf	STATUS, 5
	...
	movlw	b'11001000'	; asychron, 9-bit, cont. Receive
	movwf	RCSTA
...
; hier die eigene Adresse abfragen
	...
	btfss	PORTB, 3
	bcf	DEV_Adr, 3
;	btfss	PORTB, 4	; geht nicht, da Schalt-Ausgang
;	bcf	DEV_Adr, 4
	btfss	PORTB, 7
	bcf	DEV_Adr, 4
	btfss	PORTB, 6
...
main_Stell
	movf	COLOR_R, W	; ROT holen
;	movf	COLOR_G, W	; GRÜN holen
;	movf	COLOR_B, W	; BLAU holen
	movwf	Stellwert
...
; kam eine Adresse?
	...
	btfsc	RX_Status, 0
	goto	main		; wenn eine Adresse kam, zurück	
