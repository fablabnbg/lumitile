...
; 29.09.2005
;	-Versuch, unter 64 gleichzeitig die Periodendauer zu verlängern!
;
; ********************************************************************************************
	LIST P=16F88
; ********************************************************************************************
...
#define	Stellwert	72	; IST-Stellwert (über Rampe)
#define	Pulsweite	73	; Impulse pro Einheit
#define	H_Stellwert	74
#define	CounterT	75
#define	PORT_B		78
...
#define	StartTime	d'208'

; ********************************************************************************************
; ********************************************************************************************
;16F628-Configs---------------------------------------------------------------------
	__IDLOCS	H'3582' ;       User ID
;-----------------------------------------------------------------------------------
;
_CONFIG1	EQU	H'2007'			    
_CONFIG2	EQU	H'2008'	
...
;	subwf	Stellwert, W
	...
	btfss	STATUS, 0
	goto	main_Count	; Stellwert > 208, dann springe nach main_Count

; 200 abzüglich Stellwert von der Timereinstellung abziehen (damit wird Zeit länger)
	movwf	H_Stellwert	; jetzt steht Differenz drin
