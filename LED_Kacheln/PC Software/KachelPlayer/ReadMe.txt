========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ESCollect
========================================================================


Diese ESCollect-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre ESCollect-Anwendung bilden.
...
ESCollect.h
	...
	Anwendungsklasse CESCollectApp.
...
res\ESCollect.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei ESCollect.rc eingebunden.
...
ESCollectDlg.h, ESCollectDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CESCollectDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in ESCollect.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	ESCollect.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
