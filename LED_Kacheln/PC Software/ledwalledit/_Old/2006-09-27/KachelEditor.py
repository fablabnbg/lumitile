...
class LedGrid (wx.grid.Grid):
  ...
  #
  #member customcolours	NEU 0.98: die Custom colours links unten merken
  ...
  def __init__(self, parent,id):
    ...
    self.undoedit  = None
    self.clicktime = 0
    self.customcolours = [wx.NullColour] * 16	#anfangs weiterhin undefiniert
  ...
  def OnColorPicker(self, event):
    ...
    map(data.SetCustomColour, range(16), self.customcolours)
    
    if dlg.ShowModal() == wx.ID_OK:	#OK gedrueckt, neue Farbe in die Zelle[n]
